// XTG (1-bit) and XTH (2-bit) page encoders for XTEink e-readers.
...
/**
 * Convert ImageData to XTG format (1-bit, row-major, bit set = white).
 */
...
/**
 * Convert ImageData to XTH format (2-bit, two column-major planes, mirrored).
 */
